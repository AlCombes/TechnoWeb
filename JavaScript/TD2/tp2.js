...
// Ecrire la fonction « ajouterCarte » qui ajoute une nouvelle carte connaissant son numéro (4, 5, 6, …) comme
// fils de l’élément d’id j1. Toutes les cartes auront les mêmes propriétés (celles de la question ci‐dessus) sauf
// l’id et l’ancre.
...
// Déplacer une carte : Ecrire la fonction « deplacerCarte » qui déplace la première carte en dernier.
...
// Défilement des cartes : utiliser la fonction javascript setInterval pour faire défiler automatiquement
// toutes les cartes au rythme d’une carte toutes les 2 secondes. Utiliser pour cela la fonction précédente
// deplacerCarte.
setInterval(deplacerCarte, 2000);

// Retourner une carte : écrire une fonction permettant de retourner une carte (la carte apparait alors avec un
//     fond blanc sur lequel est écrit le numéro)
